...
class FileExplorer extends Component {
   ...
   */
	...
	onCreateItem(event, item) {
		this.setState({ showContextMenu: false, showDialog: true, showInfoDialog: false, showCreateDialog: true });
	}
	...
	onClickGetInfo(event) {
		this.setState({ showContextMenu: false, showDialog: true, showInfoDialog: true, showCreateDialog: false });
	}
				...
				{this.state.showDialog && (
					<Dialog>
						...
						{this.state.showCreateDialog && (
							<CreateItemDialog {...this.state.selectedItem} closeHandler={this.closeHandler} />
						)}
					</Dialog>
				)}
			</div>
